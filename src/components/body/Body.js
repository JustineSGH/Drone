                ...
                <div className="container-fluid">
                        ...
                        <div className="col-xl-3 col-sm-6 mb-3">
                            <div className="card text-white bg-primary o-hidden h-100">
                                <div className="card-body">
                                    ...
                                    <div className="mr-5">Démarrer les mesures</div>
                                </div>
                    ...
                    <div className="row">
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-4 text-center my-auto">
                                            ...
                                            <div className="small text-muted">Température plus haute</div>
                                            <hr/>
                                            ...
                                            <div className="small text-muted">Température plus basse</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4">
                            <div className="card mb-3">
                                <div className="card-header">
                                <i className="fa fa-pie-chart"></i>Oxygène</div>
                                <div className="card-body">
